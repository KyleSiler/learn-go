...
func main() {
	...
	// go postAPI("placerville", "https://2591j46p8g-dsn.algolia.net/1/indexes/*/queries?x-algolia-agent=Algolia for JavaScript (4.9.1); Browser (lite); JS Helper (3.4.4)&x-algolia-api-key=78311e75e16dd6273d6b00cd6c21db3c&x-algolia-application-id=2591J46P8G", "placerville-request.json", &wg)
	wg.Wait()
}
